...
$id_empresa=$_SESSION['empresa'];
	...
	$title="Configuración | Garoto";
	
	$query_empresa=mysqli_query($con,"SELECT * from empresa where id_empresa=$id_empresa");
...
<html lang="en">
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-condensed">
                    <tbody>
                      ...
                      <tr>
                        <td>Teléfono:</td>
                        <td><input type="text" class="form-control input-sm" name="telefono" value="<?php echo $row['telf_empresa']?>" required></td>
                      </tr>
                      <tr>
                        <td>Correo electrónico:</td>
                        <td><input type="email" class="form-control input-sm" name="email" value="<?php echo $row['email_empresa']?>" ></td>
                      </tr>				
					<tr>
                        <td>Dirección:</td>
                        <td><input type="text" class="form-control input-sm" name="direccion" value="<?php echo $row["direccion_empresa"];?>" required></td>
                      </tr>
					  <tr>
                        <td>Ciudad:</td>
                        <td><input type="text" class="form-control input-sm" name="ciudad" value="<?php echo $row["cuidad_empresa"];?>" required></td>
                      </tr>
					  <tr>
                        <td>Región/Provincia:</td>
                        <td><input type="text" class="form-control input-sm" name="estado" value="<?php echo $row["estado_empresa"];?>"></td>
                      </tr>
					  <tr>
                        <td>Código postal:</td>
  ...
  <h2></h2>
  <p>GLOSA</p>
  <p><a class="btn btn-primary btn-lg" href="#" role="button">Detalle</a></p>
</div>
