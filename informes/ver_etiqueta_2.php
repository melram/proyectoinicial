...
leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" rightmargin="0"*/
  ...
  <body style="font-family: Arial Narrow, sans-serif; font-size: 7px;margin-bottom:0" onload='Print();' leftmargin="1" topmargin="10"     >
  <div id="factura"> 
...
?>
  ...
  <table style="height: 50mm;margin-bottom: 0px;"> 
  	<tr>
  						<td>
							<table border="1" style="width: 48mm;height: 49mm; border-collapse: collapse;table-layout:fixed;"  >
							<thead>
							...
							<tfoot >
								<tr>
								<td  colspan="2" style="font-family:Code_39; font-size: 28px;text-align: center;">*<?php echo $rw2['codigo_barra'];?>*</td>
								</tr>
								<tr>
...
<!------------------------------------------------------------------------------------------------------->
						<td>
							<table border="1" style="width: 48mm;height: 49mm;margin-left: 4mm;table-layout:fixed;">
							<thead>
								<tr><td  colspan="2"  height="10%" style="font-family:Arial; font-size: 8px;text-align: center;"><?php echo $rw2['nombre_producto'];?></td></tr>
							</thead>
							<tbody >
							...
							<tfoot >
								...
								<tr>
								<tr>
								<td  colspan="2" style="font-size: 7px;text-align: center;">Imp. Otuño Nieto S.A Mz H-Sitio 41-M.B.I. Iquique-Chile <br>
								www.ortunonieto.cl / Telf:(57)2269001-2269002 </td>
								</tr>
							</tfoot>
							</table>
